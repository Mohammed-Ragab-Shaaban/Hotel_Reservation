      ...
      <div className="manualContainer flex flex-col sm:flex-row *:grow gap-3 sm:*:w-1/2">
        <div className="flex justify-center items-center">
          <h1 className="headingFont text-4xl">
            LET’S START YOUR JOURENY WITH STAYEASE
          </h1>
        </div>
        <div className="flex gap-3">
          ...
          <div className="m-auto">
            <button
              type="submit"
              className="contact_us bg-black rounded-full w-32 h-32 m-auto block text-center text-white"
            >
              Contact Us
            </button>
          </div>
