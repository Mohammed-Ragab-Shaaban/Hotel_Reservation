    ...
    <div>
      <div className='manualContainer py-10'>
            <div className='text-center p-10 text-6xl'>
                <h1 className='headingFont textEffect' ref={textEffectRef}> Quality Services & <br /> Activities Near you</h1>
            </div>
...
export function Service(props) {
  return (
            <div className='*:hover:scale-y-100 flex justify-center items-center text-white min-h-96 p-3 sm:w-1/4'  
