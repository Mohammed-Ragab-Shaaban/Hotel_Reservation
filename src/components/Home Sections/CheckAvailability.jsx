        ...
        <form action="" onSubmit={handleSubmit}>
          <div className="py-5 text-white gap-2 flex flex-col sm:flex-row items-center justify-center *:self-stretch *:grow">
            ...
            <div className="flex flex-col *:p-2 relative">
              ...
              <div
                className={`absolute ${
                  guest ? "opacity-100" : "opacity-0"
                } transition-all duration-500 bg-black z-30 left-0 right-0 top-full min-w-52`}
              >
                <ul className=" p-2">
            ...
            <div className="m-auto">
              <button
                type="submit"
                className="bg-main-color rounded-full w-28 h-28 m-auto block text-center"
              >
